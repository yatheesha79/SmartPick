...
export declare class ReplicateTextToImageTask extends ReplicateTask implements TextToImageTaskHelper {
    preparePayload(params: BodyParams): Record<string, unknown>;
    getResponse(res: ReplicateOutput | Blob, url?: string, headers?: Record<string, string>, outputType?: OutputType, signal?: AbortSignal): Promise<string | Blob | Record<string, unknown>>;
}
export declare class ReplicateTextToSpeechTask extends ReplicateTask {
    preparePayload(params: BodyParams): Record<string, unknown>;
    getResponse(response: ReplicateOutput, _url?: string, _headers?: HeadersInit, _outputType?: undefined, signal?: AbortSignal): Promise<Blob>;
}
...
export declare class ReplicateAutomaticSpeechRecognitionTask extends ReplicateTask implements AutomaticSpeechRecognitionTaskHelper {
    ...
    getResponse(response: ReplicateOutput, _url?: string, _headers?: HeadersInit, _outputType?: undefined, signal?: AbortSignal): Promise<AutomaticSpeechRecognitionOutput>;
}
