...
import { BaseConversationalTask, TaskProviderHelper, type ImageToTextTaskHelper, type TextToImageTaskHelper } from "./providerHelper.js";
declare abstract class ZaiTask extends TaskProviderHelper {
    constructor();
...
export declare class ZaiTextToImageTask extends ZaiTask implements TextToImageTaskHelper {
    makeRoute(): string;
    preparePayload(params: BodyParams): Record<string, unknown>;
    getResponse(response: ZaiTextToImageResponse, url?: string, headers?: Record<string, string>, outputType?: OutputType, signal?: AbortSignal): Promise<string | Blob | Record<string, unknown>>;
}
interface ZaiLayoutParsingResponse {
    md_results?: string;
}
export declare class ZaiImageToTextTask extends ZaiTask implements ImageToTextTaskHelper {
    makeRoute(): string;
    preparePayloadAsync(args: ImageToTextArgs, signal?: AbortSignal): Promise<RequestArgs>;
    preparePayload(params: BodyParams): Record<string, unknown>;
    getResponse(response: ZaiLayoutParsingResponse): Promise<ImageToTextOutput>;
}
export {};
